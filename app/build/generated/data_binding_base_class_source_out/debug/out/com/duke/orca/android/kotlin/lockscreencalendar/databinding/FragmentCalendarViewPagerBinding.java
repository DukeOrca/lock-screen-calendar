...
public final class FragmentCalendarViewPagerBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentCalendarViewPagerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCalendarViewPagerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_calendar_view_pager, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCalendarViewPagerBinding bind(@NonNull View rootView) {
